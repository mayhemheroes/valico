...
COPY --from=builder /valico/fuzz/target/x86_64-unknown-linux-gnu/release/compile /
COPY --from=builder /valico/fuzz/target/x86_64-unknown-linux-gnu/release/validate /
